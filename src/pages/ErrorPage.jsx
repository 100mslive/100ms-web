...
function ErrorPage({ error }) {
    ...
    return (
        <div className={`${theme === 'dark' ? "text-white" : "text-black"} w-full h-full flex items-center justify-center`}>
            <div className="relative rounded-xl overflow-hidden">
                <img src={(theme === "dark" ? errorBgDark : errorBgLight)} alt="error background" />
