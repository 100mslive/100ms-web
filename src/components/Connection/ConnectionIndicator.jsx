      ...
      <Wrapper isTile={isTile}>
        ...
        >
          <path
            ...
            fill={getColor(3, downlinkScore, defaultColor)}
          ...
          <path
            ...
            fill={getColor(2, downlinkScore, defaultColor)}
            transform="translate(-.333)"
          />
          <path
            ...
            fill={getColor(1, downlinkScore, defaultColor)}
          />
          <path
            ...
            fill={getColor(0, downlinkScore, defaultColor)}
          />
        </svg>
      </Wrapper>
    </Tooltip>
